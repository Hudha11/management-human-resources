            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col text-end">
                        ...
                        <a href="{{ route('presence.index') }}" class="btn btn-danger">
                    ...
                    <tbody>
                        ...
                        @foreach ($presenceDetails as $item)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('presence-detail.destroy', $item->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
...
@push('js')
    <script>
        function copyLink() {
            // const url = {{ route('absen.index', $presence->slug) }};
